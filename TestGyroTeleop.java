...
@TeleOp(name="TestGyroTeleop", group="Pushbot")
public class TestGyroTeleop extends LinearOpMode {
    ...
    public void runOpMode() {
        front_left_wheel = hardwareMap.dcMotor.get("fl_motor");
        back_left_wheel = hardwareMap.dcMotor.get("bl_motor");
        back_right_wheel = hardwareMap.dcMotor.get("br_motor");
        front_right_wheel = hardwareMap.dcMotor.get("fr_motor");
